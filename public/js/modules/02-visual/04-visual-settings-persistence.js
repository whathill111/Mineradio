...
function readSavedLyricLayout() {
  ...
  try {
    ...
    var savedBgMotionMode = normalizeBackgroundMotionMode(raw.backgroundMotionMode || fxDefaults.backgroundMotionMode);
    ...
    return {
      ...
      backgroundMotionMode: savedBgMotionMode,
...
function saveLyricLayout(opts) {
  ...
  try {
    ...
    var autosavePayload = {
      ...
      backgroundMotionMode: normalizeBackgroundMotionMode(fx.backgroundMotionMode || fxDefaults.backgroundMotionMode),

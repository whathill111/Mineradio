...
var openAudioStatus = { provider: 'open', loggedIn: false, searchReady: true, publicCatalog: true, playbackReady: true, requiresLogin: false, nickname: '开放音频', vipType: 0, vipLevel: 'none', isVip: false, isSvip: false };
...
var PLAYBACK_RESUME_LONG_PAUSE_PROVIDER_MS = { qishui: 3 * 60 * 1000, qq: 8 * 60 * 1000, kugou: 8 * 60 * 1000, open: 12 * 60 * 1000, netease: 12 * 60 * 1000 };
...
var PLAYBACK_QUALITY_DEFAULTS = { netease: 'hires', qq: 'lossless', kugou: 'lossless', qishui: 'standard', spotify: 'standard', open: 'standard' };
var PLAYBACK_QUALITY_OPTIONS = {
  ...
  open: [
    { key: 'standard', title: '开放授权原始音频', sub: 'Internet Archive / 无需会员' }
  ]
};
